"""Controller metadata and data contracts.

This module owns the controller-side data contracts used at the runtime
boundary.  It intentionally contains no solver, physics-engine, logger,
renderer, or scenario-loading logic.

The public controller base/protocol lives in simulation.controllers.base.
"""
