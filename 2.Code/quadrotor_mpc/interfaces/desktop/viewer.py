...
from quadrotor_mpc.core.obstacle_motion import normalize_obstacle
from quadrotor_mpc.estimation.native import EstimationOptions
from quadrotor_mpc.interfaces.desktop.model import PanelRuntimeContext
from quadrotor_mpc.interfaces.desktop.panel import DesktopPanelOptions, DesktopPanelProcess
...
class NativeMuJoCoConfig:
    """Validated configuration consumed by the native CLI adapter."""
...
class NativeMuJoCoViewer:
    ...
    Physics and controller execution remain owned by the native application runtime. This
