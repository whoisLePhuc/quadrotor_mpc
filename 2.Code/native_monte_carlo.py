...
from mujoco_native import NativeMuJoCoConfig
...
def _build_controller(config: NativeMuJoCoConfig):
    ...
    from native_safety_fallback import SafeFallbackController
...
def _save_markdown_report(
    ...
    lines.extend(
        [
            ...
            "",
            (
                "Use `run_native_monte_carlo.py --config config/native_monte_carlo.yaml`. "
