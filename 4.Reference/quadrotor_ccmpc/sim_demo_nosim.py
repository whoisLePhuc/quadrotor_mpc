...
class QuadrotorSim:
    ...
    def __init__(self, args) -> None:
        ...
        # Initial state for CTE calculation
        self._init_pos: npt.NDArray[np.float64] = np.array(start[:3], dtype=np.float64)
        ...
        self._mu = None  # MuJoCo model/data (lazy init)
    ...
    def _init_mujoco(self):
        """Lazy initialize MuJoCo model + data for engine=mujoco."""
        ...
        self._mu = (mj, model, data, MixerCls(mass=sum(model.body_mass)))
        return self._mu
